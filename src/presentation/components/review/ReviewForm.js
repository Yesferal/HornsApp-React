...
import { DisabledFieldComponent } from "../common/disabled.field.component";
    ...
    return (
        <div className="form-wrapper">
            <Formik {...props}
                ...
                {({ values }) => (
                    <Form>
                        <Field name="autoGeneratedKey" component={DisabledFieldComponent} />

                        <Field name="docVersion" component={DisabledFieldComponent} />

                        <Field name="lastUpdate" component={DisabledFieldComponent} />
